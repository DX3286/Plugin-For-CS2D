...
[1]={{51,52,53},38,'Grenade Pack'},
[2]={{69},7,'Machete'},
[3]={{90},12,'M134'},
[4]={{91},7,'FNF2000'},
[5]={{30},18,'AK47(Zombie Edition)'},
...
state=z2(32,7)
--[[	#For ZB [1]:zbhp [2]:zbmaxhp [3]:zbdie [4]:recovery [5]:speedboost 
...
if supply_img[r]~=nil then
freeimage(supply_img[r])
end
end
end
end
...
if state[i][4]==0 and state[i][1]+5<=state[i][2] then state[i][1]=state[i][1]+5 end
end
end
end
...
msg('\169000255000'..player(i,'name')..' got \169255000000'..supply_items[pick][3]..' @C')
